            ...
            <div class="card shadow-sm">
                <div class="card-header p-5 rounded-top">
                    <div class="d-flex w-100 justify-content-between align-items-center">
                        <h3 class="fw-bolder mb-0">{{ __('Disclaimer Page') }}</h3>
                    </div>
                </div>

                <div class="card-body p-5">
                    <form action="{{ route('admin-disclaimer.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-12">
                                ...
                                <textarea name="content" id="disclaimer_content" rows="3"
